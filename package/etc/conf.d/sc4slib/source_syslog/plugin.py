...
for port_id in ports.split(","):
    outputText = tm.render(
        ...
        port_tls_log_iw_size=os.getenv(f"SC4S_SOURCE_TLS_IW_SIZE", "200000"),
        port_tls_log_fetch_limit=os.getenv(f"SC4S_SOURCE_TLS_FETCH_LIMIT", "100"),
        ...
        port_6587_log_iw_size=os.getenv(f"SC4S_SOURCE_RFC6587_IW_SIZE", "200000"),
        port_6587_log_fetch_limit=os.getenv(f"SC4S_SOURCE_RFC6587_FETCH_LIMIT", "100"),
        ...
        port_5425_log_iw_size=os.getenv(f"SC4S_SOURCE_RFC5425_IW_SIZE", "200000"),
